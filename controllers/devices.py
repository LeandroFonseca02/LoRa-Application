...
def devices_agps():
    ...
    return render_template('devices.html', devices=all_devices, app="agps", page="devicesgps")

@devices.route('/devices/WT')
def devices_wt():
    all_devices = Device.get_all_devices_by_app_id(Application.get_appid_by_name("Water Tank"))
    return render_template('devices.html', devices=all_devices, app="wt", page="deviceswt")
